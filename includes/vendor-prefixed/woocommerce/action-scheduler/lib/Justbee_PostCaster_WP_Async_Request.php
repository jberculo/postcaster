...
if ( ! class_exists( 'Justbee_PostCaster_WP_Async_Request' ) ) {

	/**
	 * Abstract Justbee_PostCaster_WP_Async_Request class.
	 *
	 * @abstract
	 */
	abstract class Justbee_PostCaster_WP_Async_Request {
