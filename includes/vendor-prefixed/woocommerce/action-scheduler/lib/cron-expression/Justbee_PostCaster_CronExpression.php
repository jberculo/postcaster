 ...
 */
class Justbee_PostCaster_CronExpression
{
    const MINUTE = 0;
    const HOUR = 1;
    const DAY = 2;
    ...
    /**
     * @var Justbee_PostCaster_CronExpression_FieldFactory CRON field factory
     */
    ...
    /**
     * Factory method to create a new Justbee_PostCaster_CronExpression.
     *
     ...
     *
*@param Justbee_PostCaster_CronExpression_FieldFactory $fieldFactory (optional) Field factory to use
     *
     * @return Justbee_PostCaster_CronExpression
     */
    public static function factory($expression, ?Justbee_PostCaster_CronExpression_FieldFactory $fieldFactory = null)
    {
        $mappings = array(
            '@yearly' => '0 0 1 1 *',
            '@annually' => '0 0 1 1 *',
        ...
        return new self($expression, $fieldFactory ? $fieldFactory : new Justbee_PostCaster_CronExpression_FieldFactory());
    }
     ...
     * @param Justbee_PostCaster_CronExpression_FieldFactory $fieldFactory Factory to create cron fields
     */
    public function __construct($expression, Justbee_PostCaster_CronExpression_FieldFactory $fieldFactory)
    {
     ...
     * @return DateTime
     * @throws RuntimeException on too many iterations
     * @see Justbee_PostCaster_CronExpression::getNextRunDate
     */
