 ...
 */
class Justbee_PostCaster_ActionScheduler_WPCLI_QueueRunner extends Justbee_PostCaster_ActionScheduler_Abstract_QueueRunner {
	...
	/**
	 * Justbee_PostCaster_ActionScheduler_WPCLI_QueueRunner constructor.
	 *
	 ...
	 * @param null|Justbee_PostCaster_ActionScheduler_Action $action The instance of the action. Default to null for backward compatibility.
	 */
	...
	protected function stop_the_insanity( $sleep_time = 0 ) {
		_deprecated_function( 'Justbee_PostCaster_ActionScheduler_WPCLI_QueueRunner::stop_the_insanity', '3.0.0', 'Justbee_PostCaster_ActionScheduler_DataController::free_memory' );

		Justbee_PostCaster_ActionScheduler_DataController::free_memory();
	}
