 ...
 */
class Justbee_PostCaster_ActionScheduler_WPCLI_Clean_Command extends WP_CLI_Command {
	/**
	...
	public function clean( $args, $assoc_args ) {
		...
		try {
			...
			$cleaner = new Justbee_PostCaster_ActionScheduler_QueueCleaner( null, $batch );
