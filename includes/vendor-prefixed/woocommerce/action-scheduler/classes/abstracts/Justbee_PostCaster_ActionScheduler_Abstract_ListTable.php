 ...
 * @since  2.0.0
 */
abstract class Justbee_PostCaster_ActionScheduler_Abstract_ListTable extends WP_List_Table {
	...
	protected function display_filter_by_status() {
		...
		$status_labels             = Justbee_PostCaster_ActionScheduler_Store::instance()->get_status_labels();
