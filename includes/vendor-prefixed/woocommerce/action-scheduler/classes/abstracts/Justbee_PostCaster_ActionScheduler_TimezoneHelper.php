...
/**
 * Class Justbee_PostCaster_ActionScheduler_TimezoneHelper
 *
 * @license GPL-3.0-or-later
 * Modified by justbee on 08-May-2026 using {@see https://github.com/BrianHenryIE/strauss}.
 */
abstract class Justbee_PostCaster_ActionScheduler_TimezoneHelper {
	...
	public static function set_local_timezone( DateTime $date ) {
		...
		// Accept a DateTime for easier backward compatibility, even though we require methods on Justbee_PostCaster_ActionScheduler_DateTime.
		if ( ! is_a( $date, 'Justbee_PostCaster_ActionScheduler_DateTime' ) ) {
