...
/**
 * Class Justbee_PostCaster_ActionScheduler_Abstract_Schema
 *
 ...
 */
abstract class Justbee_PostCaster_ActionScheduler_Abstract_Schema {
	...
	private function schema_update_required() {
		...
		if ( 0 === $this->db_version ) {
			...
			switch ( static::class ) {
				case 'Justbee_PostCaster_ActionScheduler_StoreSchema':
					$plugin_option_name .= 'Action_Scheduler\Custom_Tables\DB_Store_Table_Maker';
					break;
				case 'Justbee_PostCaster_ActionScheduler_LoggerSchema':
