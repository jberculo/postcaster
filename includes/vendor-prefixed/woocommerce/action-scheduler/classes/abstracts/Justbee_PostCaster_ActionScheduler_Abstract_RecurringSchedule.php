...
/**
 * Class Justbee_PostCaster_ActionScheduler_Abstract_RecurringSchedule
 *
 * @license GPL-3.0-or-later
 * Modified by justbee on 08-May-2026 using {@see https://github.com/BrianHenryIE/strauss}.
 */
abstract class Justbee_PostCaster_ActionScheduler_Abstract_RecurringSchedule extends Justbee_PostCaster_ActionScheduler_Abstract_Schedule {
	 ...
	 * case of Justbee_PostCaster_ActionScheduler_IntervalSchedule, or a cron expression, as in the
	 * case of Justbee_PostCaster_ActionScheduler_CronSchedule. Or something else.
	 *
	 * @var mixed
	 */
	 ...
	 * to equivalent data. For example, Justbee_PostCaster_ActionScheduler_IntervalSchedule::start_timestamp
	 * was the same as Justbee_PostCaster_ActionScheduler_SimpleSchedule::timestamp. This was addressed in
