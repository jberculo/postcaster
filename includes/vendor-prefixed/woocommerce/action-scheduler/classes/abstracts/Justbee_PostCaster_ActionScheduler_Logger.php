...
/**
 * Class Justbee_PostCaster_ActionScheduler_Logger
 *
 * @codeCoverageIgnore
 *
 ...
 */
abstract class Justbee_PostCaster_ActionScheduler_Logger {
	 ...
	 * Get instance.
	 *
	 * @return Justbee_PostCaster_ActionScheduler_Logger
	 */
	public static function instance() {
		if ( empty( self::$logger ) ) {
			$class        = apply_filters( 'action_scheduler_logger_class', 'Justbee_PostCaster_ActionScheduler_wpCommentLogger' );
	 ...
	 *
	 * @param int                         $action_id Action ID.
	 * @param null|Justbee_PostCaster_ActionScheduler_Action $action Action.
	 * @param string                      $context Action execution context.
	 */
