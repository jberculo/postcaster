...
/**
 * Class Justbee_PostCaster_ActionScheduler_LogEntry
 *
...
class Justbee_PostCaster_ActionScheduler_LogEntry {
	...
	public function __construct( $action_id, $message, $date = null ) {
		/*
		 * Justbee_PostCaster_ActionScheduler_wpCommentLogger::get_entry() previously passed a 3rd param of $comment->comment_type
		 * to Justbee_PostCaster_ActionScheduler_LogEntry::__construct(), goodness knows why, and the Follow-up Emails plugin
		 * hard-codes loading its own version of Justbee_PostCaster_ActionScheduler_wpCommentLogger with that out-dated method,
