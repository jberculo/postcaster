...
/**
 * Class Justbee_PostCaster_ActionScheduler_Versions
 *
...
class Justbee_PostCaster_ActionScheduler_Versions {
	/**
	 * Justbee_PostCaster_ActionScheduler_Versions instance.
	 *
	 * @var Justbee_PostCaster_ActionScheduler_Versions
	 */
	 ...
	 * Get instance.
	 *
	 * @return Justbee_PostCaster_ActionScheduler_Versions
	 * @codeCoverageIgnore
	 */
	 ...
	 *     ]
	 *
	 * @deprecated 3.9.2 Use Justbee_PostCaster_ActionScheduler_SystemInformation::active_source().
	 *
	 * @return array
	 */
	public function active_source(): array {
		_deprecated_function( __METHOD__, '3.9.2', 'Justbee_PostCaster_ActionScheduler_SystemInformation::active_source()' );
		return Justbee_PostCaster_ActionScheduler_SystemInformation::active_source();
	}

	/**
	 * Returns the directory path for the currently active installation of Action Scheduler.
	 *
	 * @deprecated 3.9.2 Use Justbee_PostCaster_ActionScheduler_SystemInformation::active_source_path().
	 *
	 * @return string
	 */
	public function active_source_path(): string {
		_deprecated_function( __METHOD__, '3.9.2', 'Justbee_PostCaster_ActionScheduler_SystemInformation::active_source_path()' );
		return Justbee_PostCaster_ActionScheduler_SystemInformation::active_source_path();
	}
}
