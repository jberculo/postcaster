...
/**
 * Class Justbee_PostCaster_ActionScheduler_WPCommentCleaner
 *
 * @since 3.0.0
 *
...
class Justbee_PostCaster_ActionScheduler_WPCommentCleaner {
	...
	/**
	 * An instance of the Justbee_PostCaster_ActionScheduler_wpCommentLogger class to interact with the comments table.
	 *
	 * This instance should only be used as an interface. It should not be initialized.
	 *
	 * @var Justbee_PostCaster_ActionScheduler_wpCommentLogger
	 */
	...
	public static function init() {
		if ( empty( self::$wp_comment_logger ) ) {
			self::$wp_comment_logger = new Justbee_PostCaster_ActionScheduler_wpCommentLogger();
		}
	...
	public static function maybe_schedule_cleanup() {
		...
		$args = array(
			'type'   => Justbee_PostCaster_ActionScheduler_wpCommentLogger::TYPE,
			'number' => 1,
			'fields' => 'ids',
		);
	...
	public static function delete_all_action_comments() {
		...
		$wpdb->delete(
			$wpdb->comments,
			array(
				'comment_type'  => Justbee_PostCaster_ActionScheduler_wpCommentLogger::TYPE,
				'comment_agent' => Justbee_PostCaster_ActionScheduler_wpCommentLogger::AGENT,
			)
		);
