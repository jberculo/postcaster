...
/**
 * Justbee_PostCaster_ActionScheduler_AsyncRequest_QueueRunner class.
 */
class Justbee_PostCaster_ActionScheduler_AsyncRequest_QueueRunner extends Justbee_PostCaster_WP_Async_Request {
	...
	public function maybe_dispatch() {
		...
		$this->dispatch();
		Justbee_PostCaster_ActionScheduler_QueueRunner::instance()->unhook_dispatch_async_request();
	}
	...
	protected function allow() {
		...
		if ( ! has_action( 'action_scheduler_run_queue' ) || Justbee_PostCaster_ActionScheduler::runner()->has_maximum_concurrent_batches() || ! $this->store->has_pending_actions_due() ) {
			$allow = false;
		} else {
			$allow = true;
		}
