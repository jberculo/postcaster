...
use Justbee_PostCaster_ActionScheduler_Store as Store;
use Justbee\PostCaster\Vendor\Action_Scheduler\Migration\Runner;
use Justbee\PostCaster\Vendor\Action_Scheduler\Migration\Config;
use Justbee\PostCaster\Vendor\Action_Scheduler\Migration\Controller;

/**
 * Class Justbee_PostCaster_ActionScheduler_HybridStore
 *
 * A wrapper around multiple stores that fetches data from both.
 *
 * @since 3.0.0
 */
class Justbee_PostCaster_ActionScheduler_HybridStore extends Store {
	 ...
	 * Runner instance.
	 *
	 * @var Justbee\PostCaster\Vendor\Action_Scheduler\Migration\Runner
	 */
	...
	/**
	 * Justbee_PostCaster_ActionScheduler_HybridStore constructor.
	 *
	...
	public function set_autoincrement( $table_name, $table_suffix ) {
		if ( Justbee_PostCaster_ActionScheduler_StoreSchema::ACTIONS_TABLE === $table_suffix ) {
			...
			$null_action  = new Justbee_PostCaster_ActionScheduler_NullAction();
			...
			$row_count = $wpdb->insert(
				$wpdb->{Justbee_PostCaster_ActionScheduler_StoreSchema::ACTIONS_TABLE},
				array(
	 ...
	 *
	 * @param Justbee_PostCaster_ActionScheduler_Action $action Action object to be saved.
	 * @param DateTime|null          $date Optional. Schedule date. Default null.
	 *
	 * @return int The action ID
	 */
	public function save_action( Justbee_PostCaster_ActionScheduler_Action $action, ?DateTime $date = null ) {
