...
/**
 * Class Justbee_PostCaster_ActionScheduler_wpPostStore_PostStatusRegistrar
 *
 * @codeCoverageIgnore
 *
...
class Justbee_PostCaster_ActionScheduler_wpPostStore_PostStatusRegistrar {
	...
	public function register() {
		register_post_status( Justbee_PostCaster_ActionScheduler_Store::STATUS_RUNNING, array_merge( $this->post_status_args(), $this->post_status_running_labels() ) );
		register_post_status( Justbee_PostCaster_ActionScheduler_Store::STATUS_FAILED, array_merge( $this->post_status_args(), $this->post_status_failed_labels() ) );
	}
