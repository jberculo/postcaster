...
/**
 * Class Justbee_PostCaster_ActionScheduler_wpPostStore_PostTypeRegistrar
 *
 * @codeCoverageIgnore
 *
...
class Justbee_PostCaster_ActionScheduler_wpPostStore_PostTypeRegistrar {
	...
	public function register() {
		register_post_type( Justbee_PostCaster_ActionScheduler_wpPostStore::POST_TYPE, $this->post_type_args() );
	}
