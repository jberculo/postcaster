...
/**
 * Class Justbee_PostCaster_ActionScheduler_wcSystemStatus
 */
class Justbee_PostCaster_ActionScheduler_wcSystemStatus {
	...
	/**
	 * Constructor method for Justbee_PostCaster_ActionScheduler_wcSystemStatus.
	 *
	 * @param Justbee_PostCaster_ActionScheduler_Store $store Active store object.
	 *
	 * @return void
	 */
	...
	protected function get_template( $status_labels, $action_counts, $oldest_and_newest ) {
		...
		$as_datastore = get_class( Justbee_PostCaster_ActionScheduler_Store::instance() );
		?>
