...
/**
 * Class Justbee_PostCaster_ActionScheduler_QueueCleaner
 *
...
class Justbee_PostCaster_ActionScheduler_QueueCleaner {
	...
	private $default_statuses_to_purge = array(
		...
		Justbee_PostCaster_ActionScheduler_Store::STATUS_CANCELED,
	);

	/**
	 * Justbee_PostCaster_ActionScheduler_QueueCleaner constructor.
	 *
	 * @param Justbee_PostCaster_ActionScheduler_Store|null $store      The store instance.
	 * @param int                        $batch_size The batch size.
	 */
	public function __construct( ?Justbee_PostCaster_ActionScheduler_Store $store = null, $batch_size = 20 ) {
	 ...
	 *
	 * When called by Justbee_PostCaster_ActionScheduler_Abstract_QueueRunner::run_cleanup(), the time limit passed
	...
	public function mark_failures( $time_limit = 300 ) {
		...
		$actions_to_reset = $this->store->query_actions(
			array(
				'status'           => Justbee_PostCaster_ActionScheduler_Store::STATUS_RUNNING,
				'modified'         => $cutoff,
				'modified_compare' => '<=',
				'per_page'         => $this->get_batch_size(),
				'orderby'          => 'none',
