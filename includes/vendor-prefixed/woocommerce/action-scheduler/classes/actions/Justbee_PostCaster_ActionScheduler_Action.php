...
/**
 * Class Justbee_PostCaster_ActionScheduler_Action
 *
...
class Justbee_PostCaster_ActionScheduler_Action {
	 ...
	 * Action's schedule.
	 *
	 * @var Justbee_PostCaster_ActionScheduler_Schedule
	 */
	...
	public function __construct( $hook, array $args = array(), ?Justbee_PostCaster_ActionScheduler_Schedule $schedule = null, $group = '' ) {
		$schedule = empty( $schedule ) ? new Justbee_PostCaster_ActionScheduler_NullSchedule() : $schedule;
		$this->set_hook( $hook );
	 ...
	 */
	protected function set_schedule( Justbee_PostCaster_ActionScheduler_Schedule $schedule ) {
	 ...
	 * Action's schedule.
	 *
	 * @return Justbee_PostCaster_ActionScheduler_Schedule
	 */
