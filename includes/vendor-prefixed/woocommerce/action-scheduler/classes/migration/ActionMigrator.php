...
class ActionMigrator {
	 ...
	 *
	 * @param \Justbee_PostCaster_ActionScheduler_Store $source_store Source store object.
	 * @param \Justbee_PostCaster_ActionScheduler_Store $destination_store Destination store object.
	 * @param LogMigrator            $log_migrator Log migrator object.
	 */
	public function __construct( \Justbee_PostCaster_ActionScheduler_Store $source_store, \Justbee_PostCaster_ActionScheduler_Store $destination_store, LogMigrator $log_migrator ) {
	...
	public function migrate( $source_action_id ) {
		...
		try {
			...
			$last_attempt_date = ( \Justbee_PostCaster_ActionScheduler_Store::STATUS_PENDING !== $status ) ? $this->source->get_date( $source_action_id ) : null;
		...
		try {
			switch ( $status ) {
				case \Justbee_PostCaster_ActionScheduler_Store::STATUS_FAILED:
