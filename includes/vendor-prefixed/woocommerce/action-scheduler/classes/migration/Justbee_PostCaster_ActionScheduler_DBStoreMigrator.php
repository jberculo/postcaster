...
/**
 * Class Justbee_PostCaster_ActionScheduler_DBStoreMigrator
 *
 ...
 */
class Justbee_PostCaster_ActionScheduler_DBStoreMigrator extends Justbee_PostCaster_ActionScheduler_DBStore {
	 ...
	 *
	 * @param Justbee_PostCaster_ActionScheduler_Action $action Action to migrate.
	 ...
	 */
	public function save_action( Justbee_PostCaster_ActionScheduler_Action $action, ?DateTime $scheduled_date = null, ?DateTime $last_attempt_date = null ) {
		try {
			/**
			 * Global.
			 *
