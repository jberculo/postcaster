...
/**
 * Class Justbee_PostCaster_ActionScheduler_AdminView
 *
 * @codeCoverageIgnore
 *
 ...
 */
class Justbee_PostCaster_ActionScheduler_AdminView extends Justbee_PostCaster_ActionScheduler_AdminView_Deprecated {
	...
	/**
	 * Justbee_PostCaster_ActionScheduler_ListTable instance.
	 *
	 * @var Justbee_PostCaster_ActionScheduler_ListTable
	 */
	 ...
	 * Get instance.
	 *
	 * @return Justbee_PostCaster_ActionScheduler_AdminView
	 * @codeCoverageIgnore
	 */
	public static function instance() {

		if ( empty( self::$admin_view ) ) {
			$class            = apply_filters( 'action_scheduler_admin_view_class', 'Justbee_PostCaster_ActionScheduler_AdminView' );
	...
	public function system_status_report() {
		$table = new Justbee_PostCaster_ActionScheduler_wcSystemStatus( Justbee_PostCaster_ActionScheduler::store() );
		$table->render();
	}
	 ...
	 *
	 * @return Justbee_PostCaster_ActionScheduler_ListTable
	 */
	protected function get_list_table() {
		if ( null === $this->list_table ) {
			$this->list_table = new Justbee_PostCaster_ActionScheduler_ListTable( Justbee_PostCaster_ActionScheduler::store(), Justbee_PostCaster_ActionScheduler::logger(), Justbee_PostCaster_ActionScheduler::runner() );
	...
	public function add_help_tabs() {
		...
		$as_version       = Justbee_PostCaster_ActionScheduler_Versions::instance()->latest_version();
		$as_source        = Justbee_PostCaster_ActionScheduler_SystemInformation::active_source();
		$as_source_path   = Justbee_PostCaster_ActionScheduler_SystemInformation::active_source_path();
