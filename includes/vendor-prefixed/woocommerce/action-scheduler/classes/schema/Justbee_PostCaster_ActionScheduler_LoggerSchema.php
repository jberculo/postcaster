...
/**
 * Class Justbee_PostCaster_ActionScheduler_LoggerSchema
 *
 * @codeCoverageIgnore
 *
 ...
 */
class Justbee_PostCaster_ActionScheduler_LoggerSchema extends Justbee_PostCaster_ActionScheduler_Abstract_Schema {
	...
	protected function get_table_definition( $table ) {
		...
		switch ( $table ) {
			...
			case self::LOG_TABLE:
				$default_date = Justbee_PostCaster_ActionScheduler_StoreSchema::DEFAULT_DATE;
	 ...
	 *
	 * Most other schema updates happen via Justbee_PostCaster_ActionScheduler_Abstract_Schema::update_table(), however
