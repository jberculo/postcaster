 ...
 *
 * Class Justbee_PostCaster_ActionScheduler_OptionLock
 *
 * @since 3.0.0
 *
 ...
 */
class Justbee_PostCaster_ActionScheduler_OptionLock extends Justbee_PostCaster_ActionScheduler_Lock {
	 ...
	 *
	 * For example, Justbee_PostCaster_ActionScheduler_QueueRunner->maybe_dispatch_async_request() uses a lock to avoid
	 * calling Justbee_PostCaster_ActionScheduler_QueueRunner->has_maximum_concurrent_batches() every time the 'shutdown',
	 * hook is triggered, because that method calls Justbee_PostCaster_ActionScheduler_QueueRunner->store->get_claim_count()
